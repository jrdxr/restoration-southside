...
export function AccordionList({
  ...
  return visibility ? (
    <_Component
      ...
      data-open-on-hover={openOnHover}
      data-open-by-default={openByDefaultItem}
      _class={classes}
      style={style}
    >
      <_Builtin.HtmlEmbed
